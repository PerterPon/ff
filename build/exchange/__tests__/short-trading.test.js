...
const priceModule = require("../../core/price");
// Mock getPrice 函数
...
describe('Exchange - 空单交易测试', () => {
    ...
    beforeEach(() => {
        ...
        exchange = new exchange_1.Exchange(wallet, {
            shortOpen: test_utils_2.FEE_RATE.shortOpen,
            shortClose: test_utils_2.FEE_RATE.shortClose
        });
        jest.clearAllMocks();
        // 设置初始价格
        priceModule.getPrice.mockImplementation((symbol) => {
    ...
    describe('基础空单测试', () => {
        test('开空并平仓盈利', () => {
            ...
            const closeFee = amount * 38000 * test_utils_2.FEE_RATE.shortClose;
        ...
        test('开空并平仓亏损', () => {
            ...
            const closeFee = amount * 42000 * test_utils_2.FEE_RATE.shortClose;
        ...
        test('追加空单', () => {
            ...
            const openFee2 = positionValue2 * test_utils_2.FEE_RATE.shortOpen;
            ...
            exchange.closeShort(main_1.Symbol.BTC_USDT);
            // 平仓后总资产
            const closeFee = (amount1 + amount2) * 38000 * test_utils_2.FEE_RATE.shortClose;
            const finalExpected = expectedAfterDrop - closeFee;
            expect(exchange.getTotalAssetValue()).toBeCloseTo(finalExpected, 1);
        });
        test('强平场景', () => {
            ...
            const openFee = positionValue * test_utils_2.FEE_RATE.shortOpen; // 4000 * 0.001 = 4
            // 2. 价格上涨触发强平 @ 43900
            (0, test_utils_1.setMockPrice)(main_1.Symbol.BTC_USDT, liquidationPrice);
            exchange.onPriceUpdate(main_1.Symbol.BTC_USDT, liquidationPrice);
            // 计算未实现亏损
            ...
            const closeFee = closingValue * test_utils_2.FEE_RATE.shortClose; // 4390 * 0.001 = 4.39
            // 验证仓位已被强平
